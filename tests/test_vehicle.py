...
class VehicleTestCase(TestCase):
    ...
    def test_vehicle_creation(self):
        ...
        self.assertEqual(Vehicle.objects.filter(car_number="ABC123").count(), 1)

    def test_vehicle_cannot_change_enterprise_with_assigned_driver(self):
        ...
        vehicle.enterprise = new_enterprise
