...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enterprises', models.ManyToManyField(related_name='managers', to='enterprises.enterprise', verbose_name='предприятия')),
            ...
            options={
                'indexes': [models.Index(fields=['id'], name='accounts_ma_id_ea6403_idx')],
            },
        ),
    ]
